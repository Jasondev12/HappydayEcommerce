        ...
        <nav class="navbar navbar-expand-lg navbar-light main_box">
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    ...
                    <!-- Right Menu -->
                    <ul id="marginl-media-sub" class="nav navbar-nav menu_nav ml-auto">
                        <!-- if user not connected -->
                        @guest
                        <li id="marginr-media-insc" class="nav-item">
                            <a class="nav-link" href="{{ route('register') }}">
                                <img class="iconeHeader" src="{{ asset('../icones/signup.svg') }}" alt="logo inscription">
                                {{ __("Inscription") }}
                            </a>
                        </li>
                        <li id="marginr-media-log" class="nav-item submenu dropdown">
                        ...
                        @else
                        <li id="marginr-media-com" class="nav-item">
                            <a class="nav-link" href="{{ route('orders') }}">
                                <img class="iconeHeader" src="{{ asset('../icones/orders.svg') }}" alt="logo commandes">
                                {{ __("Commandes") }}
                            </a>
                        </li>
                        <li id="marginr-media-deco" class="nav-item">
                        ...
                        @endguest
                        <li id="marginr-media-basket" class="nav-item">
